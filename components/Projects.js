            ...
            <section className="bg-white dark:bg-gray-800">
                <div className="max-w-6xl mx-auto flex flex-wrap justify-center gap-8 py-20 pb-40">
                    ...
                    <div className="w-full md:w-1/2">
                        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden">
                            ...
                            <div className="p-4 relative">
                                <a href="https://power-up-fitness.netlify.app" target="_blank" className="inline-block transition duration-300 transform hover:scale-110">
                                    <img src="/project1.png" alt="project 1"/>
                                    <span className="absolute inset-0 flex items-center justify-center text-black opacity-50 pointer-events-none">Click here</span>
                                </a>
                            </div>
                        </div>
                    </div>
                    <div className="w-full md:w-1/2">
                        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden">
                            <div class="p-4">
                                <h2 class="text-2xl font-semibold text-gray-800 dark:text-gray-200">Project 4</h2>
                            </div>
                            <div className="p-4">
                                <p>Hallo ik ben redwan</p>
                            </div>
                            <div className="p-4 relative">
                                <a href="https://power-up-fitness.netlify.app" target="_blank" className="inline-block transition duration-300 transform hover:scale-110">
                                    <img src="/project1.png" alt="project 1"/>
